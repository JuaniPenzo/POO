 ...
 * Se encarga de mostrar la grilla de clases, menús y diálogos, delegando la lógica al modelo {@link Gimnasio}.
 */
public class InterfazGimnasio {
     ...
     * @param gimnasio el objeto Gimnasio con los datos del sistema.
     */
    ...
    private void onGridCellClicked(int diaIdx, int turnoIdx) {
        ...
        int sel = JOptionPane.showOptionDialog(null,
                "Clase: " + clase.getNombre() + "\nEntrenador: " + (clase.getEntrenador() != null ? clase.getEntrenador().getNombre() : "N/A") + "\nCupo: " + clase.getCupoMaximo(),
                dia + " - " + turno,
        ...
        if (sel == 0) {
            ...
            // Eliminar la clase
            int confirm = JOptionPane.showConfirmDialog(null, "¿Confirma eliminar la clase " + clase.getNombre() + "?", "Eliminar clase", JOptionPane.YES_NO_OPTION);
    ...
    private void menuSocios() {
        ...
        while (!volver) {
            ...
            switch (opcion) {
                case "1": listarSocios(); break;
                case "2": agregarSocioDesdeMenu(); break;
                case "3": eliminarSocioPorDni(); break;
                case "4": modificarSocioPorDni(); break;
    ...
    private void menuEmpleados() {
        ...
        while (!volver) {
            ...
            switch (opcion) {
                ...
                case "2": agregarEmpleadoDesdeMenu(); break;
                case "3": eliminarEmpleadoPorDni(); break;
                case "4": modificarEmpleadoPorDni(); break;
                case "0": volver = true; break;
                default: JOptionPane.showMessageDialog(null, "Opción inválida.");
            }
        }
    ...
    private void menuClases() {
        ...
        while (!volver) {
            ...
            switch (opcion) {
                ...
                case "2": agregarClaseDesdeMenu(); break;
                case "3": eliminarClaseSeleccion(); break;
                case "0": volver = true; break;
                default: JOptionPane.showMessageDialog(null, "Opción inválida.");
            }
        }
    ...
    private void menuCuentaBancaria() {
        ...
        while (!volver) {
            ...
            if (opcion == null) return;
            switch (opcion) {
                case "1": gestionarPagoSocio(); break;
                case "2": pagarSueldoEmpleadoDesdeMenu(); break;
                case "3": if (gimnasio.getCuenta() != null) {
                            ...
                            break;
                case "4": mostrarMovimientosCuentaDialog(); break;
                case "0": volver = true; break;
                default: JOptionPane.showMessageDialog(null, "Opción inválida.");
            }
        }
    ...
    private void agregarSocioDesdeMenu() {
        try {
            ...
            Socio socio = new Socio(nombre, apellido, dni, membresia, null, cuentaSocio, new java.util.Date(), new java.util.Date(), true, mesesPlan + " meses", mesesPlan);
    ...
    private void eliminarSocioPorDni() {
        try {
            ...
            int confirm = JOptionPane.showConfirmDialog(null, "¿Confirma eliminar a " + s.getNombre() + " " + s.getApellido() + "?", "Confirmar eliminación", JOptionPane.YES_NO_OPTION);
            if (confirm == JOptionPane.YES_OPTION) {
    ...
    private void agregarEmpleadoDesdeMenu() {
        try {
            ...
            String tipo = (String) JOptionPane.showInputDialog(null, "Tipo de empleado:", "Tipo", JOptionPane.QUESTION_MESSAGE, null, tiposEmpleado, tiposEmpleado[0]);
            if (tipo == null) return;
            ...
            if (tipo.equalsIgnoreCase("Entrenador")) {
                ...
                Entrenador entrenador = new Entrenador(nombre, apellido, dni, sexo, fechaNac, sueldo, especialidad, null);
    ...
    private void eliminarEmpleadoPorDni() {
        try {
            ...
            int confirm = JOptionPane.showConfirmDialog(null, "¿Confirma eliminar a " + e.getNombre() + " " + e.getApellido() + "?", "Confirmar eliminación", JOptionPane.YES_NO_OPTION);
            if (confirm == JOptionPane.YES_OPTION) {
    ...
    private void eliminarClaseSeleccion() {
        ...
        String seleccionado = (String) JOptionPane.showInputDialog(null, "Seleccione la clase a eliminar:", "Eliminar clase",
        ...
        if (claseAEliminar == null) return;
        int confirm = JOptionPane.showConfirmDialog(null, "¿Confirma eliminar la clase " + claseAEliminar.getNombre() + " (" + claseAEliminar.getHorario() + ")?",
    ...
    private void pagarSueldoEmpleadoDesdeMenu() {
        try {
            ...
            boolean pagado = e.cobrarSueldo(gimnasio.getCuenta());
            if (pagado) {
    ...
    private void mostrarMovimientosCuentaDialog() {
        ...
        String[] años = {"Todos", String.valueOf(añoActual - 1), String.valueOf(añoActual), String.valueOf(añoActual + 1)};
        ...
        DefaultTableModel modeloTabla = new DefaultTableModel(new Object[]{"Fecha", "Tipo", "Descripción", "Monto"}, 0) {
        ...
        Runnable poblarTabla = () -> {
            ...
            lblResumen.setText(String.format("Total HABER: $%.2f   Total DEBE: $%.2f   Neto: $%.2f", totalHaber, totalDebe, neto));
        };
